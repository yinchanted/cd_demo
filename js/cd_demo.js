...
d3.csv("data/cd_demo.csv", function (data) {
    ...
    var fiscalYearDim = facts.dimension(dc.pluck('demo date'));
    ...
    // 08 make row charts
    new RowChart(facts, "Division", 300, 100);
    new RowChart(facts, "Department", 300, 10);
    new RowChart(facts, "Role", 300, 10);
